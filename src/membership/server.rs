use utils::{time, BoxFutureResult};
...
impl Service for HeartbeatService {
    fn ping(&self, id: u64) -> BoxFutureResult<(), ()> {
...
impl StateMachineCmds for Membership {
    fn hb_online_changed(&mut self, online: Vec<u64>, offline: Vec<u64>) -> BoxFutureResult<(), ()> {
        self.version += 1;
        {
    ...
    fn join(&mut self, address: String) -> BoxFutureResult<u64, ()> {
        self.version += 1;
    ...
    fn leave(&mut self, id: u64) -> BoxFutureResult<(), ()> {
    ...
    fn join_group(&mut self, group_name: String, id: u64) -> BoxFutureResult<(), ()> {
    ...
    fn leave_group(&mut self, group_id: u64, id: u64) -> BoxFutureResult<(), ()> {
        self.version += 1;
        self.leave_group_(group_id, id, true)
    }
    fn new_group(&mut self, name: String) -> BoxFutureResult<u64, u64> {
        self.version += 1;
    ...
    fn del_group(&mut self, id: u64) -> BoxFutureResult<(), ()> {
        self.version += 1;
    ...
    fn group_leader(&self, group_id: u64) -> BoxFutureResult<(Option<ClientMember>, u64), ()> {
    ...
    fn group_members(&self, group: u64, online_only: bool) -> BoxFutureResult<(Vec<ClientMember>, u64), ()> {
        if let Some(group) = self.groups.get(&group) {
    ...
    fn all_members(&self, online_only: bool) -> BoxFutureResult<(Vec<ClientMember>, u64), ()> {
